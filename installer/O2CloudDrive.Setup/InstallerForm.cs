...
internal sealed class InstallerForm : Form
{
    ...
    public InstallerForm()
    {
        ...
        Text = "O2 Cloud Drive 0.8.2 beta";
    ...
    private async void OnInstallClicked(object? sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MessageBox.Show(
                NeedsReboot
                    ? "O2 Cloud Drive 0.8.2 beta se ha instalado correctamente. WinFsp ha pedido reiniciar Windows antes de montar unidades."
                    : "O2 Cloud Drive 0.8.2 beta se ha instalado correctamente.",
                "O2 Cloud Drive",
                MessageBoxButtons.OK,
