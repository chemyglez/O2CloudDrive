...
internal sealed class InstallerForm : Form
{
    ...
    private async void OnInstallClicked(object? sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MessageBox.Show(
                NeedsReboot
                    ? "O2 Cloud Drive 0.7 beta se ha instalado correctamente. WinFsp ha pedido reiniciar Windows antes de montar unidades."
                    : "O2 Cloud Drive 0.7 beta se ha instalado correctamente.",
                "O2 Cloud Drive",
                MessageBoxButtons.OK,
