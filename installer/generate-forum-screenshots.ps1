...
function Draw-InstallerScreenshot {
    New-Canvas (Join-Path $outDir "01-instalador.png") {
        param($g)
        Draw-Window $g 240 160 800 380 "O2 Cloud Drive 0.8 beta"
...
function Draw-MainAppScreenshot {
    New-Canvas (Join-Path $outDir "03-aplicacion-principal.png") {
        ...
        Draw-Text $g "O2 Cloud Drive 0.8 beta" (New-Font 18 ([System.Drawing.FontStyle]::Bold)) (ColorRgb 27 34 42) ([System.Drawing.RectangleF]::new(222, 164, 520, 44))
